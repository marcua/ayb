...
use crate::e2e_tests::{
    ...
    test_entity_details_and_profile, test_export_and_import, test_health_check,
    test_oauth_token_exchange_errors, test_permissions, test_registration, test_snapshots,
    test_snapshots_duckdb, test_token_management,
};
...
async fn client_server_integration(
    ...
    // This test creates imported databases and would change the
