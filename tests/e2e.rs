...
use crate::e2e_tests::{
    ...
    test_oauth_permission_capping, test_oauth_token_exchange, test_permissions, test_registration,
...
async fn client_server_integration(
    ...
    test_oauth_permission_capping(&config_path, &api_keys, server_url).await?;
